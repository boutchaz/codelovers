  ...
  return (
    <section className="reveal-on-scroll py-28">
      <div className="mx-auto w-full max-w-[1320px] px-6 text-center lg:px-8">
        <div className="rounded-[40px] border border-white/10 bg-gradient-to-r from-rose-600/35 via-red-500/25 to-orange-400/30 p-8 sm:p-12 lg:p-16 backdrop-blur">
          <RevealText
            as="h2"
            className="block"
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <Link
              href="#services"
              className="inline-flex items-center gap-2 rounded-full border border-white/40 px-6 py-2.5 sm:px-8 sm:py-3 text-sm font-semibold text-white transition hover:border-white hover:text-rose-200"
            >
